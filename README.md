...
quality scan. `build` runs the same static gate and then builds the synthetic target with signing
disabled. Absence of a workflow run is `NOT_RUN_BY_USER_DECISION`, never PASS or FAIL.
